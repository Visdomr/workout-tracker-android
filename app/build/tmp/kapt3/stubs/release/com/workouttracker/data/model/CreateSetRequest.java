...
public final class CreateSetRequest {
    ...
    public CreateSetRequest(long exerciseId, int setNumber, int reps, double weight, double distance, int duration, int restTime) {
        super();
    }
    ...
    public final com.workouttracker.data.model.CreateSetRequest copy(long exerciseId, int setNumber, int reps, double weight, double distance, int duration, int restTime) {
        return null;
    }
